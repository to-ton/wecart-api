...
if(isset($_GET['confirm'])){
    $id = $_GET['confirm'];
    $sql = "update register set isverify='yes' where id='$id'";
    ...
    $reset = "update register set id='$random_string' where id='$id'";
    $mysqli->query($reset);
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10b es-m-txt-c">
                                                                                        <h1 style="font-size: 46px; line-height: 100%;">You're all set!</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
